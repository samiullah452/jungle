def keyword_finder(key,company):
	...
	req = requests.get('https://smartstore.naver.com/'+company+'/products/'+key)
	...
	for category in categorys:
		...
		if len(category.attrs)==1 and a.find('lcatid')!=-1:
			...
			content[i]['url']='https://smartstore.naver.com/'+company+'/products/'+key
			i+=1
			return content